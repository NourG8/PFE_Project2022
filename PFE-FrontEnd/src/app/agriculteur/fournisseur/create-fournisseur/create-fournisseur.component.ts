...
export class CreateFournisseurComponent implements OnInit {
  ...
  save() {
    ...
    this.fournisseurService
      .getFournisseurNom(this.myForm.get('nom')?.value)
      .subscribe((t) => {
        this.fournisseurService
          .getFournisseurPrenom(this.myForm.get('prenom')?.value)
          .subscribe((h) => {
            console.log(t);
            if (t == 1 && h == 1) {
              this.msg1 = 1;
            ...
            this.fournisseurService
              .getFournisseurMatricule(this.myForm.get('matricule')?.value)
              .subscribe((l) => {
                console.log(l);
                if (l == 1) {
                  this.msg2 = 1;
                    ...
                    .subscribe(
                      (o) => {
                        ...
                        localStorage.setItem(
                          ...
                          JSON.stringify([
                            'Success',
                            'Un fournisseur a été ajouté avec succès',
                          ])
                        );
                        this.onClose();
                      },
