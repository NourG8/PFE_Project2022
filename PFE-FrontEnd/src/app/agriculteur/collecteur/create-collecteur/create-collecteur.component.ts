...
export class CreateCollecteurComponent implements OnInit {
  ...
  save() {
    ...
    this.collecteurService
      .getCollecteurNomCollecteur(this.myForm.get('nomCollecteur')?.value)
      .subscribe((t) => {
        console.log(t);
        if (t == 1) {
          this.msg1 = 1;
        ...
        this.collecteurService
          .getCollecteurMatricule(this.myForm.get('matricule')?.value)
          .subscribe((m) => {
            console.log(m);
            if (m == 1) {
              this.msg3 = 1;
            ...
            this.collecteurService
              .getCollecteurTel(this.myForm.get('tel')?.value)
              .subscribe((l) => {
                console.log(l);
                if (l == 1) {
                  this.msg2 = 1;
                    ...
                    .subscribe(
                      (o) => {
                        ...
                        localStorage.setItem(
                          ...
                          JSON.stringify([
                            'Success',
                            'Un collecteur a été ajouté avec succès',
                          ])
                        );
                        this.onClose();
                      },
